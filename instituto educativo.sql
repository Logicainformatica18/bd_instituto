...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-01-2021 a las 03:13:25
...
DROP PROCEDURE IF EXISTS `Alumno_Cambiar_clave`$$
...
DROP PROCEDURE IF EXISTS `Alumno_foto_delete`$$
...
DROP PROCEDURE IF EXISTS `Alumno_foto_insert`$$
...
DROP PROCEDURE IF EXISTS `Alumno_foto_update`$$
...
DROP PROCEDURE IF EXISTS `Alumno_Insert`$$
...
DROP PROCEDURE IF EXISTS `Alumno_mensaje_insert`$$
...
DROP PROCEDURE IF EXISTS `Alumno_search`$$
...
DROP PROCEDURE IF EXISTS `Alumno_Select`$$
...
DROP PROCEDURE IF EXISTS `Alumno_Update`$$
...
DROP PROCEDURE IF EXISTS `Alumno_Update_Select`$$
...
DROP PROCEDURE IF EXISTS `asistencia_insert`$$
...
DROP PROCEDURE IF EXISTS `asistencia_marcar`$$
...
DROP PROCEDURE IF EXISTS `asistencia_reporte_actual`$$
...
DROP PROCEDURE IF EXISTS `Carrera_superior_select`$$
...
DROP PROCEDURE IF EXISTS `Curso_insert`$$
...
DROP PROCEDURE IF EXISTS `Curso_select`$$
...
DROP PROCEDURE IF EXISTS `evaluacion_examen`$$
...
DROP PROCEDURE IF EXISTS `evaluacion_insert`$$
...
DROP PROCEDURE IF EXISTS `Habitante_ver_nota`$$
...
DROP PROCEDURE IF EXISTS `mensaje_select`$$
...
DROP PROCEDURE IF EXISTS `notas_alumno_insert`$$
...
DROP PROCEDURE IF EXISTS `notas_alumno_select`$$
...
DROP PROCEDURE IF EXISTS `notas_insert`$$
...
DROP PROCEDURE IF EXISTS `notas_update`$$
...
DROP PROCEDURE IF EXISTS `nota_curso_select`$$
...
DROP PROCEDURE IF EXISTS `profesorist_cambiar_clave`$$
...
DROP PROCEDURE IF EXISTS `profesorist_foto_delete`$$
...
DROP PROCEDURE IF EXISTS `profesorist_foto_update`$$
...
DROP PROCEDURE IF EXISTS `profesorist_Insert`$$
...
DROP PROCEDURE IF EXISTS `profesorIST_login`$$
...
DROP PROCEDURE IF EXISTS `profesorIST_select`$$
...
DROP PROCEDURE IF EXISTS `profesorist_Update`$$
...
DROP PROCEDURE IF EXISTS `Profesorist_Update_Select`$$
...
DROP PROCEDURE IF EXISTS `Publicacion_insert`$$
...
DROP PROCEDURE IF EXISTS `publicacion_search`$$
...
DROP PROCEDURE IF EXISTS `publicacion_select`$$
...
DROP PROCEDURE IF EXISTS `registro_alumno_delete`$$
...
DROP PROCEDURE IF EXISTS `registro_detalle_insert`$$
...
DROP PROCEDURE IF EXISTS `registro_entregado`$$
...
DROP PROCEDURE IF EXISTS `Registro_insert`$$
...
DROP PROCEDURE IF EXISTS `registro_profesor_delete`$$
...
DROP PROCEDURE IF EXISTS `registro_search`$$
...
DROP PROCEDURE IF EXISTS `Registro_select`$$
